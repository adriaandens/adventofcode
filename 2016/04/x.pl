...
while(<DATA>) {
	...
	print "Sector ID: $sectorid - checksum: $checksum\n";
	...
	$sum += $sectorid if $checkie[0] eq $sorted[0] && $checkie[1] eq $sorted[1] && $checkie[2] eq $sorted[2] && $checkie[3] eq $sorted[3] && $checkie[4] eq $sorted[4];
	%amount = (); # reset
}
print "Sol: $sum\n";
